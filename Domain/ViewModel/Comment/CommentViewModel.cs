...
public class CommentViewModel
{
    ...
    [Display(Name = "نقاط قوت")] public string Strengths { get; set; }

    [Display(Name = "نقاط ضعف")] public string Weaknesses { get; set; }

    [Display(Name = "وضعیت تایید")] public bool IsApproved { get; set; }
    ...
    [Display(Name = "تعداد پسندها")] public int Likes { get; set; } = 0;

    [Display(Name = "تعداد نپسندها")] public int Dislikes { get; set; } = 0;
}
