...
public class NovinoGetPaymentUrlResponseDto
{
    ...
    [JsonProperty("data")] public NovinoGetPaymentUrlRequestData Data { get; set; }
...
{
    [JsonProperty("wage")] public int Wage { get; set; }

    [JsonProperty("wage_payer")] public string WagePayer { get; set; }
